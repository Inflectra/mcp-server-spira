...
async def _get_my_incidents_impl(spira_client, limit: int, offset: int) -> str:
    """
    ...
    try:
        ...
        all_incidents = await spira_client.make_spira_api_get_request(incidents_url)
...
def register_tools(mcp) -> None:
    ...
    async def get_my_incidents(limit: int = 25, offset: int = 0) -> str:
        """
        ...
        **Pagination:** Client-side (API returns all, sliced in Python).
        ...
        try:
            ...
            return await _get_my_incidents_impl(spira_client, limit, offset)
