...
class TestCreateBuild:
    ...
    @pytest.mark.asyncio
    async def test_create_build_success(self):
        ...
        # Act
        result = await _create_build_url_impl(
            mock_client,
            product_id=55,
            release_id=10,
            build_status_id=2,
    ...
    @pytest.mark.asyncio
    async def test_create_build_failed_status(self):
    ...
    @pytest.mark.asyncio
    async def test_create_build_no_commits(self):
    ...
    @pytest.mark.asyncio
    async def test_create_build_invalid_product_id_negative(self):
    ...
    @pytest.mark.asyncio
    async def test_create_build_invalid_product_id_zero(self):
    ...
    @pytest.mark.asyncio
    async def test_create_build_invalid_release_id_negative(self):
    ...
    @pytest.mark.asyncio
    async def test_create_build_invalid_release_id_zero(self):
    ...
    @pytest.mark.asyncio
    async def test_create_build_invalid_build_status_zero(self):
    ...
    @pytest.mark.asyncio
    async def test_create_build_invalid_build_status_three(self):
    ...
    @pytest.mark.asyncio
    async def test_create_build_empty_name(self):
    ...
    @pytest.mark.asyncio
    async def test_create_build_whitespace_name(self):
    ...
    @pytest.mark.asyncio
    async def test_create_build_api_returns_none(self):
    ...
    @pytest.mark.asyncio
    async def test_create_build_api_missing_build_id(self):
    ...
    @pytest.mark.asyncio
    async def test_create_build_api_exception(self):
    ...
    @pytest.mark.asyncio
    async def test_create_build_multiple_commits(self):
    ...
    @pytest.mark.asyncio
    async def test_create_build_preserves_all_fields(self):
