...
class TestGetMyRequirementsImpl:
    ...
    async def test_successful_retrieval_with_default_pagination(self):
        ...
        result = await _get_my_requirements_impl(mock_client, limit=25, offset=0)
    ...
    async def test_successful_retrieval_middle_page(self):
        ...
        result = await _get_my_requirements_impl(mock_client, limit=25, offset=25)
    ...
    async def test_successful_retrieval_last_page_full(self):
        ...
        result = await _get_my_requirements_impl(mock_client, limit=25, offset=75)
    ...
    async def test_empty_results_with_offset(self):
        ...
        result = await _get_my_requirements_impl(mock_client, limit=25, offset=50)
    ...
    async def test_custom_limit(self):
        ...
        result = await _get_my_requirements_impl(mock_client, limit=50, offset=0)
    ...
    async def test_limit_larger_than_total(self):
        ...
        result = await _get_my_requirements_impl(mock_client, limit=100, offset=0)
    ...
    @pytest.mark.asyncio
    async def test_single_requirement(self):
    ...
    @pytest.mark.asyncio
    async def test_preserves_requirement_data_structure(self):
    ...
    async def test_pagination_metadata_accuracy(self):
        ...
        for limit, offset, expected_returned, expected_total, expected_has_more in test_cases:
            result = await _get_my_requirements_impl(mock_client, limit=limit, offset=offset)
            parsed = json.loads(result)
...
class TestGetMyRequirementsRealAPIIntegration:
    ...
    async def test_pagination_works_with_real_data(self, spira_client):
        ...
        # Get first page
        result1 = await _get_my_requirements_impl(spira_client, limit=5, offset=0)
        parsed1 = json.loads(result1)

        # Get second page
        result2 = await _get_my_requirements_impl(spira_client, limit=5, offset=5)
    ...
    async def test_handles_empty_results(self, spira_client):
        ...
        result = await _get_my_requirements_impl(spira_client, limit=25, offset=10000)
        parsed = json.loads(result)
    ...
    @pytest.mark.asyncio
    async def test_preserves_requirement_fields(self, spira_client):
