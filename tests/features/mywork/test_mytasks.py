...
class TestGetMyTasksImpl:
    ...
    def test_successful_retrieval_middle_page(self):
        ...
        result = _get_my_tasks_impl(mock_client, limit=25, offset=25)
    ...
    def test_successful_retrieval_last_page_full(self):
        ...
        result = _get_my_tasks_impl(mock_client, limit=25, offset=75)
    ...
    def test_empty_results_with_offset(self):
        ...
        result = _get_my_tasks_impl(mock_client, limit=25, offset=50)
    ...
    def test_custom_limit(self):
        ...
        result = _get_my_tasks_impl(mock_client, limit=50, offset=0)
    ...
    def test_limit_larger_than_total(self):
        ...
        result = _get_my_tasks_impl(mock_client, limit=100, offset=0)
    ...
    def test_preserves_task_data_structure(self):
    ...
    def test_pagination_metadata_accuracy(self):
        ...
        for limit, offset, expected_returned, expected_total, expected_has_more in test_cases:
            result = _get_my_tasks_impl(mock_client, limit=limit, offset=offset)
            parsed = json.loads(result)
...
class TestGetMyTasksRealAPIIntegration:
    ...
    def test_pagination_works_with_real_data(self, spira_client):
        ...
        # Get first page
        result1 = _get_my_tasks_impl(spira_client, limit=5, offset=0)
        parsed1 = json.loads(result1)

        # Get second page
        result2 = _get_my_tasks_impl(spira_client, limit=5, offset=5)
    ...
    def test_handles_empty_results(self, spira_client):
        ...
        result = _get_my_tasks_impl(spira_client, limit=25, offset=10000)
        parsed = json.loads(result)
    ...
    def test_preserves_task_fields(self, spira_client):
