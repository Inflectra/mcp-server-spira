...
class TestGetRequirementsMCPWrapper:
    ...
    async def test_successful_call_through_wrapper(self, mock_get_client):
        ...
        result = await get_requirements_wrapper(product_id=55)
    ...
    async def test_validation_error_invalid_product_id(self, mock_get_client):
        ...
        get_requirements_wrapper = capture_registered_tool(register_tools)
        result = await get_requirements_wrapper(product_id=-1)
    ...
    async def test_validation_error_invalid_starting_row(self, mock_get_client):
        ...
        get_requirements_wrapper = capture_registered_tool(register_tools)
        result = await get_requirements_wrapper(product_id=55, starting_row=0)
    ...
    async def test_validation_error_invalid_number_of_rows(self, mock_get_client):
        ...
        get_requirements_wrapper = capture_registered_tool(register_tools)
        result = await get_requirements_wrapper(product_id=55, number_of_rows=0)
    ...
    async def test_all_parameters_passed_through(self, mock_get_client):
        ...
        get_requirements_wrapper = capture_registered_tool(register_tools)
        await get_requirements_wrapper(product_id=55, starting_row=20, number_of_rows=75)
