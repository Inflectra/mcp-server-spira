"""
Unit tests for product artifacts test sets tools.

Tests the get_test_sets MCP tool wrapper, validation, and error handling.
"""
...
@pytest.mark.unit
class TestGetTestSetsMCPWrapper:
    """Tests for get_test_sets MCP tool wrapper."""

    def test_tool_registration(self):
        """Test that get_test_sets tool is registered with MCP."""
        mock_mcp = Mock()
